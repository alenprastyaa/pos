          ...
          >
            ...
            >
              <div
                ...
                class="dropdown-text space-y-1 border border-gray-200 p-2"
              >
            ...
            <tbody class="divide-y divide-border">
              <tr v-if="transactionItems.length === 0">
                <td colspan="6" class="px-6 py-12 text-center text-muted-light">
                  <div class="space-y-2">
                    <svg
                      class="w-12 h-12 mx-auto opacity-40"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
              ...
              >
                ...
                <td
                  class="px-6 text-right text-xl text-gray-800 font-semibold border border-gray-800"
                >
      ...
      >
        ...
        <div class="space-y-4">
          <div>
            ...
            <div class="relative">
              <span
                class="absolute left-4 top-1/2 -translate-y-1/2 text-xl font-semibold text-muted"
                >Rp</span
              >
              <input
          ...
          <div class="card-section p-5 border rounded-lg space-y-3 bg-gray-50">
            ...
            <div
              class="flex justify-between text-base border-t pt-3 border-divider"
            ...
            <div
              class="flex justify-between text-2xl border-t pt-3 border-divider font-bold"
