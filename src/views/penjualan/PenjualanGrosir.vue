    ...
    <AdminLayout>
        <div class="page-container py-2 space-y-2 min-h-screen">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap- p-4">
                ...
                <div>
                    <label class="block text-xl font-semibold label-text mb-2 ml-3"> Pilih Pelanggan </label>
                    <select ref="pelangganSelectRef" v-model="selectedPelangganId" required style="font-size: 12px"
                        ...
                        <thead>
                            <tr class="table-header border-b">
                                <th style="font-size: 15px"
                                    class="px-6 text-white py-4 text-left uppercase tracking-wider th-text">
                                    No
                                </th>
                                <th style="font-size: 15px"
                                    class="px-6 text-white py-4 text-left uppercase tracking-wider th-text">
                                ...
                                <th style="font-size: 15px"
                                    class="px-6 text-white py-4 text-center uppercase tracking-wider th-text">
                                    Qty
                                </th>
                                <th style="font-size: 15px"
                                    class="px-6 text-white py-4 text-right uppercase tracking-wider th-text">
                                    Harga
                                </th>
                                <th style="font-size: 15px"
                                    class="px-6 text-white py-4 text-right uppercase tracking-wider th-text">
...
const generateReceiptHTML = (
    ...
    // Asumsi fungsi formatDateTime tersedia global, jika tidak, bisa gunakan toLocaleDateString
    ...
    ">
        ...
        <div style="display: flex; justify-content: space-between; font-weight: bold; font-size: 10px; margin: 10px 0 5px 0; border-bottom: 1px dashed #000; padding-bottom: 5px;">
        ...
        <div style="margin-bottom: 10px;">
            ${items.map((item) => `
                <div style="display: flex; justify-content: space-between; margin-bottom: 8px; align-items: flex-start;">
                    ...
                    <span style="width: 55px; text-align: right;">${formatCurrency(item.qty * item.harga_jual_ritel)}</span>
                </div>
            `).join('')}
        </div>
        ...
        <div style="margin-top: 15px; text-align: center; font-size: 10px; line-height: 1.6; color: #333;">
            <div style="margin-bottom: 4px;">Terima Kasih Atas Kunjungan Anda</div>
